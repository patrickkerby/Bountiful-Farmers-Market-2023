            ...
            <div class="dokan-left dokan-order-shipping-address">
                <div class="dokan-panel dokan-panel-default">
                    ...
                    <div class="dokan-panel-body">
                        ...
                        ?>
            <div class="dokan-left dokan-order-shipping-address delivery-detail-cstm">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php esc_html_e( ''.$shipping_method.' Details', 'dokan-lite' ); ?></strong></div>
                    <div class="dokan-panel-body">
                        <?php echo $show_date_time; ?>
                    </div>
                </div>
            </div>
