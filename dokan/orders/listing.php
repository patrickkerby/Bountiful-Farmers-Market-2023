        ...
        <table class="dokan-table dokan-table-striped">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e( 'Date Placed', 'dokan-lite' ); ?></th>
                    <th><?php esc_html_e( 'Date of Delivery/Pickup', 'dokan-lite' ); ?></th>
         ...
         //           $order_date = $order->order_date;
			      ...
			      echo '<abbr title="' . esc_attr( dokan_date_time_format( $t_time ) ) . '">' . $shipping_date[0] . '</abbr>'; ?>
                        </td>
