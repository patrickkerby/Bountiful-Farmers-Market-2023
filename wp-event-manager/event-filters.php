...
<!-- 				<div class="wpem-form-group">
			...
			<div class="wpem-col">
				<div class="wpem-form-group">
					<label for="search_datetimes" class="wpem-form-label"><?php _e('Any dates', 'wp-event-manager'); ?></label>
						<select name="date-range" id="data_range_filter_custom">
							<option value="">Choose Date Range</option>
							<option value="<?php echo date("Y");?>-<?php echo date('m');?>-01 00:00:00&<?php echo date("Y");?>-<?php echo date('m');?>-15 11:59:00">Date From : 1st to 15th</option>
							<option value="<?php echo date("Y");?>-<?php echo date('m');?>-16 00:00:00&<?php echo date("Y");?>-<?php echo date('m');?>-31 11:59:00">Date From : 16th to 31st</option>
						</select>
...
<script>
jQuery("#data_range_filter_custom").change(function(e){
	e.preventDefault();
	jQuery('.loader_custom_box').css('display', 'block');
        ...
        formData.append('action' , 'date_range_filter');
        ...
        // },
                 ...
                 success:function(result){
					 // console.log(result);
					 jQuery('#event-listing-view').html(result);
					 jQuery('.loader_custom_box').css('display', 'none');
				 }
		});
	}
