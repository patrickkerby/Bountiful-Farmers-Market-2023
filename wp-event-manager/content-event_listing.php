    ...
    <div class="wpem-event-layout-wrapper">
        <div <?php event_listing_class(''); ?>>
            <a href="<?php display_event_permalink(); ?>" class="wpem-event-action-url event-style-color <?php echo esc_attr($event_type); ?>">
                ...
                <div class="wpem-event-infomation" style="background-color: <?php echo $color; ?> ">
                    <div class="wpem-event-date">
                        <div class="wpem-event-date-type">
                            <?php
                            if (!empty($start_date)) {
                    ...
                    <div class="wpem-event-details">
                        ...
                        ?>
                            <div class="wpem-event-type"><?php //display_event_type(); ?>
                            
                            <a href="" class="custom-event-type-a"  ><span class="custom-event-type-a-span"  style="background-color: <?php echo $sub_color; ?>!important "> <?php echo $event_type ;  ?></span></a>
