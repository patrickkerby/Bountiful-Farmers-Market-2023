...
$event = $post;
?>
<section class="myevent-page_listing">
            ...
            <?php else : ?>
                        ...
                        <div class="wpem-row">
                            <div class="wpem-col-xs-12 wpem-col-sm-7 wpem-col-md-8 wpem-single-event-left-content">
                                ...
                                <div class="wpem-single-event-body-content">
                                    ...
                                    <?php $show = get_field('show_form'); ?>
                                   
                                   <?php if ($show ==  1) { ?>

                                    <h4 class="enterWin">Enter to win:</h4>
                                    <form action="" method="post" id="event_form_submit">                                
                                        
                                    <input type="hidden" class="form-control" id="event_name" name="event_name" value="<?php the_title(); ?>" />
                                     
                                      <div class="form-group">
                                        <label for="uname">Name <span>(Required)</span></label>
                                      ...
                                      <div class="form-group">
                                        <label for="pwd">Phone Number <span>(Required)</span></label>
                                       <!--  <input type="text" class="form-control" id="phone_number" name="phone_number" required> -->
                                        <input type="text" class="form-control" id="phone_number" name="phone_number"  />

                                      </div>
                                      <div class="form-group">
                                        <label for="pwd"> I agree<span>(Required)</span></label>
                                        <div class="form-check">
                                          <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="optradio" required>Contest Rules
                                          </label>
                                        </div>
                                        <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia dolore suscipit perferendis magnam sapiente placeat nemo hic pariatur reprehenderit impedit!</span>
                                      </div>
                                      <button type="submit" class="btn" id="event_submit_button">Submit</button>
                                    </form>
                ...
                <?php if (!empty($field_value)) : ?>
                                ...
                                <?php foreach ($field_value as $child_index => $child_value) : ?>
                                    ...
                                    <?php foreach ($field['fields'] as $child_field_name => $child_field) : ?>
                                        ...
                                        <?php if (!empty($child_value[$child_field_name])) : ?><div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                <div class="wpem-additional-info-block-details-content-items"> <?php                                 $my_value_arr = [];     foreach ($child_value[$child_field_name] as $key => $my_value) {
                    ...
                    <?php elseif ($field['type'] == 'select') : ?>
                        <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                            <div class="wpem-additional-info-block-details-content-items">
                                <p class="wpem-additional-info-block-title"><strong><?php printf(__('%s', 'wp-event-manager'),  $field['label']); ?> - </strong> <?php     if (isset($field['options'][$field_value]))                                                    printf(__('%s', 'wp-event-manager'),  $field['options'][$field_value]);
                            else                                                printf(__('%s', 'wp-event-manager'), $field_value);                                                ?></p>
                            </div>
                        </div>
                ...
                <?php endif; ?>
                    ...
                    // get_event_manager_template('event-registration.php');
                            echo wp_kses_post('<div class="wpem-alert wpem-alert-warning">' . __('Event registration Start.', 'wp-event-manager') . '</div>');
