...
?>
	...
	<div class="order-info">
		...
		<ul class="info-list">
            ...
            $show_date_time = "$shipping_date "." $shipping_time";
			...
			<?php endforeach; ?>
				<li>
					<strong> Order <?php echo $shipping_method; ?> :</strong>
					<span><?php echo $show_date_time; ?></span>
				</li>
		...
		<table>
			<thead>
				<tr>
					...
					<th class="head-price"><span><?php esc_attr_e( 'Vendor Name', 'woocommerce-delivery-notes' ); ?></span></th>
				...
				if ( count( $order->get_items() ) > 0 ) :
					...
					<?php foreach ( $order->get_items() as $item_id => $item ) : ?>
						...
						<tr>
							...
							<?php
								// $vendor_id = get_post_author( $product_id );
							$author_id = get_post_field( 'post_author', $product_id );
								$all_user_data = get_userdata( $author_id ); 

								$vendor_name = 	$all_user_data->user_nicename;
							 ?>
